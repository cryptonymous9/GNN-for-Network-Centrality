...
if gtype == "RD":
    print("Loading random graphs.")
    data_path = "./data/data_splits/RD/betweenness/"
elif gtype == "ER":
    print("Erdos-Renyi random graphs selected.")
    data_path = "./data/data_splits/ER/betweenness/"
elif gtype == "GRP":
    print("Gaussian Random Partition graphs selected.")
    data_path = "./data/data_splits/GRP/betweenness/"
...
def test(list_adj_test,list_adj_mod_test,list_num_node_test,bc_mat_test, k=10):
    ...
    print(f"Margin-ranking scores is: {np.mean(np.array(list_kt))} and std: {np.std(np.array(list_kt))}")
